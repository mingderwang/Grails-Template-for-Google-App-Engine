...
<html>
    ...
    <body>
        ...
        <div class="body">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:cloudsInstance, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:cloudsInstance, field:'tag')}</td>
            ...
            <div class="buttons">
                <g:form>
                    <input type="hidden" name="id" value="${cloudsInstance?.id}" />
